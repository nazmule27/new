...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2016 at 11:37 AM
...
BEGIN
        ...
        SELECT fac_name INTO FULL_NAME_FOUND FROM cseweb.fac_list WHERE fac_login = username ORDER BY fac_joining_date;
...
BEGIN
        ...
        SELECT CONCAT(fac_name," (", fac_login,")") INTO NAME_FOUND FROM cseweb.fac_list WHERE fac_login = username order by fac_joining_date;
	RETURN NAME_FOUND;
...
(1, '0411054002', 'razi', 'atif', 'headcse', 'nazmul', '2016-08-07 08:17:39', NULL),
(2, '0412052109', 'ashikurrahman', 'asmlatifulhoque', 'headcse', 'nazmul', '2016-08-07 08:42:23', NULL),
(3, '100705081', 'atif', 'ashikurrahman', 'headcse', 'nazmul', '2016-08-07 10:23:54', NULL),
(4, '0412052090', 'atif', 'kaykobad', 'headcse', 'nazmul', '2016-08-07 11:13:13', NULL);
...
(1, 'abc External', 'DR. ABC', 'Professor', 'abc@gmail.com', '123', 'Local');
...
(1, 1, 'Test Title', 'progress', '', '2016-08-07 08:40:00', 'razi', '2016-08-07 08:33:02', NULL),
(2, 2, 'Test Title', 'progress', '', '2016-08-07 09:30:00', 'ashikurrahman', '2016-08-07 08:55:24', NULL),
(3, 2, 'With can see', 'progress', '', '2016-08-07 10:00:00', 'ashikurrahman', '2016-08-07 08:56:27', NULL),
(4, 2, 'Test nazmul2', 'progress', '', '2016-08-07 11:00:00', 'ashikurrahman', '2016-08-07 08:57:25', NULL),
(5, 2, 'dummy test', 'progress', '', '2016-08-07 10:45:00', 'ashikurrahman', '2016-08-07 08:58:09', NULL),
(6, 2, 'Test nazmul2', 'comprehensive', '', '2016-08-07 05:30:00', 'ashikurrahman', '2016-08-07 09:00:38', NULL),
(7, 2, 'Test Title', 'defense', 'abc External', '2016-08-08 10:00:00', 'ashikurrahman', '2016-08-07 09:04:10', NULL),
(8, 2, 'Test Title', 'progress', '', '2016-08-07 08:30:00', 'ashikurrahman', '2016-08-07 10:26:58', NULL),
(9, 3, 'With can see', 'comprehensive', '', '2016-08-18 08:30:00', 'atif', '2016-08-07 11:15:58', NULL);
...
(1, 1, NULL, '1razi.jpg', 'pre_meeting_document', 'progress', NULL, '2016-08-07 08:33:02', 'razi'),
(2, 1, 'Test Comment', '1razi1.jpg', 'pre_meeting_document', 'progress', 1, '2016-08-07 08:36:01', 'razi'),
(3, 4, 'Comment', '2ashikurrahman.jpg', 'pre_meeting_document', 'progress', 1, '2016-08-07 08:57:25', 'ashikurrahman'),
(4, 5, 'Only comment', NULL, 'pre_meeting_document', 'progress', NULL, '2016-08-07 08:58:09', 'ashikurrahman'),
(5, 6, '', '2ashikurrahman.docx', 'pre_meeting_document', 'comprehensive', 1, '2016-08-07 09:00:38', 'ashikurrahman'),
(6, 7, 'Desfence exam', '2ashikurrahman1.docx', 'pre_meeting_document', 'defense', 1, '2016-08-07 09:04:10', 'ashikurrahman'),
(7, 8, 'jj', NULL, 'pre_meeting_document', 'progress', NULL, '2016-08-07 10:26:58', 'ashikurrahman'),
(8, 9, 'Test Comment', '3atif.jpg', 'pre_meeting_document', 'comprehensive', 1, '2016-08-07 11:15:58', 'atif'),
(9, 1, NULL, NULL, NULL, NULL, NULL, '2016-08-07 11:21:21', 'atif'),
(10, 1, 'test', '1atif.jpg', 'pre_meeting_document', 'progress', NULL, '2016-08-07 11:21:50', 'atif'),
(11, 1, 'test can see ppt', '1atif.pptx', 'pre_meeting_document', 'progress', 1, '2016-08-07 11:22:08', 'atif');
